...
function soong_build_go
{
    BUILDDIR=$(getoutdir) \
      ...
      EXTRA_ARGS="-pkg-path android/soong=${TOP}/build/soong -pkg-path xperience/soong=${TOP}/vendor/xperience/build/soong -pkg-path github.com/golang/protobuf=${TOP}/external/golang-protobuf" \
      build_go $@
}
